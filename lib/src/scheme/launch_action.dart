...
class EnvironmentVariables extends XmlElementWrapper
  ...
  EnvironmentVariable? _getVariable(String? key) {
    return _allVariables.firstWhereOrNull((element) => element.key == key);
  }

  @override
  String? operator [](Object? key) => _getVariable(key as String?)?.value;
  ...
  String? remove(Object? key) {
    var v = _getVariable(key as String?);
...
class CommandLineArguments extends XmlElementWrapper with SetMixin<String?> {
  ...
  CommandLineArgument? _getArgument(String? argument) =>
      _allArguments.firstWhereOrNull((element) => element.argument == argument);
  @override
  ...
  bool remove(Object? value) {
    var a = _getArgument(value as String?);
